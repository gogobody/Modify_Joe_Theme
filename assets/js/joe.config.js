    ...
    class Joe {
        ...
        init_index_titles(){
            ...
            titles.unbind('click').bind('click',function (e) {
                ...
                article_container.html('<div style="text-align: center"><img alt="loading" width="50px" height="auto" src="https://cdn.jsdelivr.net/gh/gogobody/Modify_Joe_Theme/assets/img/loading.svg"></div>')
