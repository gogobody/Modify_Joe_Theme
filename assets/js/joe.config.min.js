...
a.css("width",d));$(".j-aside .aside").last().css("top",c.height()+20);$(".j-floor .contain").css("top",c.height()+20);var e=$(".j-stretch .contain");e.css("top",c.height()+20);e.unbind("click").bind("click",function(){0===a.width()?(a.css("width",d),a.css("overflow","")):(a.css("width",0),a.css("overflow","hidden"));$("#commentType button[data-type='text']").click()})};b.prototype.init_sign_verify=function(){$("#loginForm").off("submit").on("submit",function(a){if(""===$("#loginForm .username").val().trim())return a.preventDefault(),
