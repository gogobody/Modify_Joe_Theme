...
function(){var a=this;$("#j-dynamic-form").on("submit",function(c){var d=this;c.preventDefault();var e=$("#j-dynamic-form .form-foot button");if(""===$("#j-dynamic-form-text").val().trim())return $.toast({type:"info",message:"\u8bf7\u8f93\u5165\u53d1\u8868\u5185\u5bb9\uff01"});$(this).attr("data-disabled")||($(this).attr("data-disabled",!0),e.text("\u53d1\u8868\u4e2d..."),$.ajax({url:$(this).attr("action"),type:"post",data:$(this).serializeArray(),success:function(k){var f=[],m="";f=$(k).contents();
Array.from(f).forEach(function(h){"container"===h.parentNode.className&&(m=h)});if(/TypechoJoeTheme/.test(k)){var g=location.href;g=a.changeURLArg(g,"jscroll","comments");$.toast({type:"success",message:"\u53d1\u8868\u6210\u529f\uff01"});setTimeout(function(){pjax.loadUrl(g)},a.options.reloadTime)}else $.toast({type:"warning",message:m.textContent||""}),$(d).removeAttr("data-disabled");e.text("\u7acb\u5373\u53d1\u8868")},error:function(k){e.text("\u7acb\u5373\u53d1\u8868")}}))})};b.prototype.init_comment_submit=
