...
$(window).scrollTop();400<n&&500>n||(450<=n?l>n&&f?(k=!1,m()):k&&(f=!1,h()):m(),l=n)})}})};d.prototype.init_navigation=function(){$("#siteNav li.nav-list-item").on("click",function(a){a.preventDefault();window.scroll({top:$($(this).children("a").attr("data-href")).offset().top-($(".j-header").height()+20),behavior:"smooth"})})};"undefined"!==typeof module&&"undefined"!==typeof module.exports?module.exports=d:window.Joe=d})();new Joe({});
