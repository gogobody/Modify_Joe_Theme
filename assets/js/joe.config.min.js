...
a();$(window).on("scroll",function(){return a()});$("#backToTop").unbind("click").bind("click",function(){window.scroll({top:0,behavior:"smooth"})})}};b.prototype.init_high_light=function(){"off"!==window.JOE_CONFIG.DOCUMENT_HIGHT_LIGHT&&(hljs.initHighlighting.called=!1,hljs.initHighlighting())};b.prototype.init_document_console=function(){"off"!==window.JOE_CONFIG.DOCUMENT_CONSOLE&&function(a,c){a||(!function(d){var e=e||{};e.create=function(k){function f(){window.Firebug&&window.Firebug.chrome&&
window.Firebug.chrome.isInitialized?m("on"):(l="off",console.log(n),console.clear(),m(l))}function m(r){p!==r&&(p=r,"function"==typeof g.onchange&&g.onchange(r))}"function"==typeof k&&(k={onchange:k});var h=(k=k||{}).delay||500,g={};g.onchange=k.onchange;var l,n=new Image;n.__defineGetter__("id",function(){l="on"});var p="unknown";g.getStatus=function(){return p};var q=setInterval(f,h);window.addEventListener("resize",f);var t;return g.free=function(){t||(t=!0,window.removeEventListener("resize",
