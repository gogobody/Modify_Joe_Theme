...
($(".j-header").height()+20),behavior:"smooth"});(e=$(e).find(".j-loadmore a").attr("href"))?$(c).attr("data-href",e):$(".j-loadmore").remove()}})}})}};b.prototype.init_document_swiper=function(){"off"!==window.JOE_CONFIG.DOCUMENT_SWIPER&&document.querySelector("#lb-1")&&(new Lb({id:"lb-1",speed:1E3,delay:5E3,direction:"left",moniterKeyEvent:!0,moniterTouchEvent:!0})).pause()};b.prototype.init_document_analysis=function(){if(0!==$("#j-video").length){var a=$("#j-dplayer"),c=$("#j-video .episodes ul li");
a.attr("src",a.attr("data-src")+c.first().attr("data-url"));c.first().addClass("active");$("#j-video .player-box .title span").html("\u6b63\u5728\u64ad\u653e\uff1a"+$("#j-video .episodes ul li span").first().html());c.unbind("click").bind("click",function(){c.removeClass("active");$(this).addClass("active");a.attr("src",a.attr("data-src")+$(this).attr("data-url"));$("#j-video .player-box .title span").html("\u6b63\u5728\u64ad\u653e\uff1a"+$(this).find("span").html())})}};b.prototype.init_owo=function(){0!==
$("#OwO_Container").length&&(new OwO({logo:"O\u03c9O\u8868\u60c5",container:document.getElementsByClassName("OwO")[0],target:document.getElementsByClassName("OwO-textarea")[0],api:window.JOE_CONFIG.THEME_URL+"/OwO.json",position:"down",width:"100%",maxHeight:"250px"}),$(document).bind("click",function(){$(".OwO").removeClass("OwO-open")}))};b.prototype.init_replay_see=function(){$(".need-reply span").unbind("click").bind("click",function(){var a=$(this).attr("data-href");window.scrollTo({top:$("#"+
a).offset().top-($(".j-header").height()+20),behavior:"smooth"})})};b.prototype.init_draw=function(){0!==$("#draw").length&&(window.sketchpad=new Sketchpad({element:"#draw",height:300,penSize:5,color:"303133"}),$("#commentTypeContent .undo").unbind("click").bind("click",function(){window.sketchpad.undo()}),$("#commentTypeContent .animate").unbind("click").bind("click",function(){window.sketchpad.animate(10)}),$("#commentTypeContent .canvas ul li").unbind("click").bind("click",function(){window.sketchpad.penSize=
$(this).attr("data-line");$("#commentTypeContent .canvas ul li").removeClass("active");$(this).addClass("active")}),$("#commentTypeContent .canvas ol li").unbind("click").bind("click",function(){window.sketchpad.color=$(this).attr("data-color");$("#commentTypeContent .canvas ol li").removeClass("active");$(this).addClass("active")}))};b.prototype.init_admire=function(){$("#j-admire").unbind("click").bind("click",function(){$(".j-admire-modal").addClass("active");$("body").css("overflow","hidden")});
$(".j-admire-modal .close").unbind("click").bind("click",function(){$(".j-admire-modal").removeClass("active");$("body").css("overflow","")})};b.prototype.init_thumbs_up=function(){$("#j-thumbs-up").unbind("click").bind("click",function(){if($(this).attr("disabled"))return $.toast({type:"warning",message:"\u672c\u7bc7\u6587\u7ae0\u60a8\u5df2\u7ecf\u8d5e\u8fc7~"});$(this).find("span").html("loading...");$.ajax({type:"post",url:$(this).attr("data-url"),data:"agree="+$(this).attr("data-cid"),timeout:3E4,
cache:!1,success:function(a){/\d/.test(a)&&$("#j-thumbs-up span").html("\u8d5e \u00b7 "+a.trim());$.toast({type:"success",message:"\u611f\u8c22\u60a8\u7684\u70b9\u8d5e\uff01"});$("#j-thumbs-up").attr("disabled","disabled")}})})};b.prototype.init_share_code=function(){var a=$("#j-share-code");0!==a.length&&a.qrcode({render:"canvas",width:90,height:90,text:encodeURI(window.location.href),background:"#ffffff",foreground:"#000000",correctLevel:0})};b.prototype.init_copy=function(){var a=$("#copyInput");
$(".j-copy").unbind("click").bind("click",function(c){c.preventDefault();$("body").append('<input id="copyInput" value="'+$(this).attr("data-copy")+'"/>');a.select();document.execCommand("copy");$.toast({type:"success",message:"\u5df2\u590d\u5236\u5230\u526a\u5207\u677f\u4e2d~"});a.remove()})};b.prototype.init_synth=function(){var a=$("#read");if(!window.speechSynthesis)return a.remove();a.unbind("click").bind("click",function(){var c=window.speechSynthesis,d=new SpeechSynthesisUtterance;"\u6717\u8bfb"===
$(this).find("span").html()?(d.lang="zh-CN",d.text=$("#markdown").text(),c.speak(d),$(this).find("span").html("\u505c\u6b62\u6717\u8bfb")):(c.cancel(d),$(this).find("span").html("\u6717\u8bfb"))})};b.prototype.init_typecho_comment=function(){window.TypechoComment={dom:function(a){return document.getElementById(a)},create:function(a,c){a=document.createElement(a);for(var d in c)a.setAttribute(d,c[d]);return a},reply:function(a,c){var d=this.dom(a),e=this.dom($(".j-comment").attr("data-respondid")),
