...
(function(){var b=function(a){this.options=a={reloadTime:a.reloadTime||1500};this.video_page=0;this.video_canLoad=!0;this.wallpaper_page=0;this.wallpaper_cid="";this.global_item={above_nav:$(".above .above-nav"),below:$(".below"),color_mode_toggle_btn:$(".js-promo-color-modes-toggle"),j_nav_link:$("nav.nav.j-nav a.link")};this.global_var={};this.init()};b.prototype.pjax_complete=function(){$(window).unbind("scroll");$(document).unbind("click");this.global_init();"post"===window.JOE_CONFIG.ARCHIVE?
this.post_init():this.page_init();this.reinit_head_title();jQuery('[data-fancybox="gallery"]').fancybox()};b.prototype.global_init=function(){$(document).on("touchstart",function(a){});$.fancybox.defaults.hash=!1;this.init_header();this.init_prefer_color_scheme();this.init_url_hash();this.init_document_title();this.init_document_barrager();this.init_document_progress();this.init_document_live2d();this.init_document_contextmenu();this.init_document_theme();this.init_hover_music();this.init_back_top();
...
!1),$(".j-barrager").css({opacity:0,visibility:"hidden"}));a.on("change",function(){localStorage.setItem("barragerStatus",$(this).prop("checked")?"on":"off");a.prop("checked")?$(".j-barrager").css({opacity:1,visibility:"visible"}):$(".j-barrager").css({opacity:0,visibility:"hidden"})})}};b.prototype.init_document_progress=function(){if("off"!==window.JOE_CONFIG.DOCUMENT_PROGRESS){var a=function(){var c=$(window).scrollTop(),d=$(document).height(),e=$(window).height();c=parseInt(c/(d-e)*100);0>c&&
(c=0);100<c&&(c=100);$("#progress").css("width",c+"%")};a();$(window).on("scroll",function(){return a()})}};b.prototype.init_document_live2d=function(){"off"!==window.JOE_CONFIG.DOCUMENT_LIVE2D&&"on"!==window.JOE_CONFIG.IS_MOBILE&&L2Dwidget.init({model:{jsonPath:window.JOE_CONFIG.DOCUMENT_LIVE2D,scale:1},mobile:{show:!1},display:{position:"right",width:160,height:200,hOffset:70,vOffset:0}})};b.prototype.init_document_contextmenu=function(){if("off"!==window.JOE_CONFIG.DOCUMENT_CONTEXTMENU&&"on"!==
...
window.JOE_CONFIG.DOCUMENT_GLOBAL_THEME:"#4e7cf2";a.colpick({flat:!0,layout:"hex",submit:!1,color:c,colorScheme:"dark",onChange:function(d,e,k){$("body").css("--theme","#"+e);localStorage.setItem("--theme","#"+e)}});$("#openColorPick").unbind("click").bind("click",function(d){d.stopPropagation();a.toggleClass("active")});a.unbind("click").bind("click",function(d){d.stopPropagation()});$(document).bind("click",function(d){a.removeClass("active")})}else""===window.JOE_CONFIG.DOCUMENT_GLOBAL_THEME?$("body").css("--theme",
...
$("#j-video .episodes ul li span").first().html());c.unbind("click").bind("click",function(){c.removeClass("active");$(this).addClass("active");a.attr("src",a.attr("data-src")+$(this).attr("data-url"));$("#j-video .player-box .title span").html("\u6b63\u5728\u64ad\u653e\uff1a"+$(this).find("span").html())})}};b.prototype.init_owo=function(){0!==$(".OwO").length&&(new OwO({logo:"O\u03c9O\u8868\u60c5",container:document.getElementsByClassName("OwO")[0],target:document.getElementsByClassName("OwO-textarea")[0],
...
a.html("<span>\u70b9\u51fb\u63a8\u9001</span>"):(a.html("\u767e\u5ea6\u5df2\u6536\u5f55"),a.css("color","#3bca72")):(a.html("\u67e5\u8be2\u5931\u8d25"),a.css("color","#f56c6c"))}});$("#baiduIncluded span").unbind("click").bind("click",function(){$.ajax({url:window.JOE_CONFIG.THEME_URL+"/baiduPush.php?urls="+encodeURI(window.location.href),method:"get",dataType:"json",data:{token:window.JOE_CONFIG.DOCUMENT_BAIDU_TOKEN,domain:window.location.hostname},success:function(c){var d={"site error":"\u7ad9\u70b9\u672a\u9a8c\u8bc1\uff01",
"empty content":"\u5185\u5bb9\u4e3a\u7a7a\uff01","only 2000 urls are allowed once":"\u8d85\u8fc7\u9650\u5236\uff01","over quota":"\u4eca\u65e5\u63d0\u4ea4\u5df2\u4e0a\u9650"};c.success?(a.css("color","#3bca72"),a.html("\u63a8\u9001\u6210\u529f")):(a.css("color","#e6a23c"),401===c.error?a.html("Token\u9519\u8bef\uff01"):400===c.error?a.html(d[c.message]||"\u672a\u77e5\u9519\u8bef"):404===c.error?a.html("\u5730\u5740\u9519\u8bef\uff01"):a.html("\u670d\u52a1\u5f02\u5e38\uff01"))}})})};b.prototype.init_typing=
function(){$(".j-typing").each(function(a,c){$(c).show();$(c).css("opacity",1);var d=$(c).html(),e=null,k=0,f=function(){k<=d.length?($(c).html(d.slice(0,k++)+"_"),e=setTimeout(f,100)):($(c).html(d),clearTimeout(e))};f()})};b.prototype.init_life_time=function(){function a(){var c=+new Date,d=(new Date((new Date).toLocaleDateString())).getTime();c=(c-d)/1E3/60/60;d=c/24*100;$("#dayProgress .title span").html(parseInt(c));$("#dayProgress .progress .progress-inner").css("width",parseInt(d)+"%");$("#dayProgress .progress .progress-percentage").html(parseInt(d)+
...
$(c).attr("href").replace("#","?jscroll="))})};b.prototype.init_replay_content=function(){$(".replyContent p").each(function(a,c){a=$(c).html();/\{!\{.*\}!\}/.test(a)&&(a=a.replace(/{!{/,"").replace(/}!}/,""),$(c).html('<img class="canvas" src="'+a+'" />'))});$(".replyContent").show()};b.prototype.init_comment=function(){$("#commentType button").unbind("click").bind("click",function(){$("#commentType button").removeClass("active");$(this).addClass("active");var a=$("#commentTypeContent .canvas");
"canvas"===$(this).attr("data-type")?($("#draw").prop("width",$("#commentTypeContent").width()),$("#commentTypeContent textarea").hide(),a.show(),a.attr("data-type","canvas")):($("#commentTypeContent textarea").show(),a.hide(),a.attr("data-type","text"))});$(".comment-list .meta a").unbind("click").bind("click",function(){$("#draw").prop("width",$("#commentTypeContent").width())});$("#cancel-comment-reply-link").unbind("click").bind("click",function(){$("#draw").prop("width",$("#commentTypeContent").width())})};
b.prototype.init_leaving=function(){function a(d,e){return Math.floor(Math.random()*(e-d+1))+d}var c=100;$("#j-leaving li").each(function(d,e){$(e).find(".body .content p").each(function(k,f){k=$(f).html();/\{!\{.*\}!\}/.test(k)&&(k=k.replace(/{!{/,"").replace(/}!}/,""),$(f).html('<img class="canvas" src="'+k+'" />'))});$(e).css({"z-index":a(1,99),"background-color":"rgba("+a(0,255)+", "+a(0,255)+", "+a(0,255)+", "+a(.8,1)+")",top:parseInt(Math.random()*($("#j-leaving").height()-$(e).height()),10),
left:parseInt(Math.random()*($("#j-leaving").width()-$(e).width()),10),display:"flex"});$(e).draggabilly({containment:!0});$(e).on("dragStart",function(k){c++;$(e).css("z-index",c)})})};b.prototype.init_wap_search_click=function(){$(".j-search-toggle").unbind("click").bind("click",function(){$(this).toggleClass("active");$(this).hasClass("active")?($(".j-nav").hide(),$(".j-search").css("display","flex")):($(".j-nav").css("display","flex"),$(".j-search").hide())})};b.prototype.init_search_verify=function(){$(".j-search").on("submit",
function(a){if(""===$(".j-search input").val().trim())return a.preventDefault(),$.toast({type:"warning",message:"\u8bf7\u8f93\u5165\u641c\u7d22\u5185\u5bb9\uff01"})})};b.prototype.init_protect_verify=function(){var a=this,c=$("#j-protected");c.on("submit",function(d){d.preventDefault();if(""===c.find(".pass").val())return $.toast({type:"info",message:"\u8bf7\u8f93\u5165\u8bbf\u95ee\u5bc6\u7801\uff01"});d=c.attr("action");$.ajax({url:d,method:"post",datatype:"text",data:{protectPassword:c.find(".pass").val(),
cid:c.find(".cid").val()},success:function(e){var k=[],f="";k=$(e).contents();Array.from(k).forEach(function(g){"container"===g.parentNode.className&&(f=g)});if(/TypechoJoeTheme/.test(e)){var m=location.href;m=a.changeURLArg(m,"jscroll","comments");$.toast({type:"success",message:"\u5bc6\u7801\u6b63\u786e\uff0c\u5373\u5c06\u5237\u65b0\u672c\u9875\uff01"});setTimeout(function(){window.location.href=m},a.options.reloadTime)}else $.toast({type:"warning",message:f.textContent||""})}})})};b.prototype.init_dynamic_verify=
function(){var a=this;$("#j-dynamic-form").on("submit",function(c){var d=this;c.preventDefault();if(""===$("#j-dynamic-form-text").val().trim())return $.toast({type:"info",message:"\u8bf7\u8f93\u5165\u53d1\u8868\u5185\u5bb9\uff01"});$(this).attr("data-disabled")||($(this).attr("data-disabled",!0),$.ajax({url:$(this).attr("action"),type:"post",data:$(this).serializeArray(),success:function(e){var k=[],f="";k=$(e).contents();Array.from(k).forEach(function(g){"container"===g.parentNode.className&&(f=
g)});if(/TypechoJoeTheme/.test(e)){var m=location.href;m=a.changeURLArg(m,"jscroll","comments");$.toast({type:"success",message:"\u53d1\u8868\u6210\u529f\uff0c\u5373\u5c06\u5237\u65b0\u672c\u9875\uff01"});setTimeout(function(){window.location.href=m},a.options.reloadTime)}else $.toast({type:"warning",message:f.textContent||""}),$(d).removeAttr("data-disabled")}}))})};b.prototype.init_comment_submit=function(){var a=this;$("#comment-form").on("submit",function(c){var d=this;c.preventDefault();if(""===
$("#comment-nick").val().trim())return $.toast({type:"warning",message:"\u8bf7\u8f93\u5165\u60a8\u7684\u6635\u79f0\uff01"});if(!/\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*/.test($("#comment-mail").val()))return $.toast({type:"warning",message:"\u8bf7\u8f93\u5165\u6b63\u786e\u7684\u90ae\u7bb1\uff01"});c=$("#comment-content");if("canvas"===$("#commentTypeContent .canvas").attr("data-type")){var e=$("#draw")[0].toDataURL("image/webp",.1);c.val("{!{"+e+"}!} ")}if(""===c.val().trim())return $.toast({type:"warning",
...
!0})},h=function(){k.removeClass("post_no");d.addClass("post_no");e.slideUp("normal",function(){m=!0})};$(document).ready(function(){var l=0;if(768>screen.width)$(window).scroll(function(){var p=$(window).scrollTop();395<p&&505>p||(450<=p?l>p&&m?(f=!1,c.slideDown("fast",function(){f=!0})):f&&(m=!1,c.slideUp("normal",function(){m=!0})):c.slideDown("fast",function(){f=!0}),l=p)});else{var n=a.width();0<k.length&&750<n&&$(window).scroll(function(){var p=$(window).scrollTop();400<p&&500>p||(450<=p?l>
p&&m?(f=!1,g()):f&&(m=!1,h()):g(),l=p)})}})}};b.prototype.init_navigation=function(){$("#siteNav li.nav-list-item").unbind("click").bind("click",function(a){a.preventDefault();$(this).siblings().removeClass("active");$(this).addClass("active");window.scroll({top:$($(this).children("a").attr("href")).offset().top-($(".j-header").height()+20),behavior:"smooth"})})};b.prototype.init_mobinav=function(){$(".navigation-tab-item").bind("click",function(){$(".navigation-tab-item").removeClass("active");$(this).addClass("active");
$(".navigation-tab-overlay").css({left:25*$(this).prevAll().length+"%"})});$("#mob_goTop").click(function(){$("#backToTop").click()});var a=$("#load_mobinav");a.hasClass("active")&&$(".navigation-tab-overlay").css({left:25*a.prevAll().length+"%"})};"undefined"!==typeof module&&"undefined"!==typeof module.exports?module.exports=b:window.Joe=b})();window.JoeInstance=new Joe({});
