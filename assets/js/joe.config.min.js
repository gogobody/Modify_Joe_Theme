...
c.addClass("post_no");e.slideUp("normal",function(){m=!0})};$(document).ready(function(){var l=0;if(768>screen.width)$(window).scroll(function(){var p=$(window).scrollTop();395<p&&505>p||(console.log(p),450<=p?l>p&&m?(f=!1,b.slideDown("fast",function(){setTimeout(function(){f=!0},300)})):f&&(m=!1,b.slideUp("normal",function(){setTimeout(function(){m=!0},300)})):b.slideDown("fast",function(){setTimeout(function(){f=!0},300)}),l=p)});else{var n=a.width();0<k.length&&750<n&&$(window).scroll(function(){var p=
$(window).scrollTop();400<p&&500>p||(450<=p?l>p&&m?(f=!1,g()):f&&(m=!1,h()):g(),l=p)})}})};d.prototype.init_navigation=function(){$("#siteNav li.nav-list-item").on("click",function(a){a.preventDefault();$(this).siblings().removeClass("active");$(this).addClass("active");window.scroll({top:$($(this).children("a").attr("href")).offset().top-($(".j-header").height()+20),behavior:"smooth"})})};d.prototype.init_mobinav=function(){$(".navigation-tab-item").bind("click",function(){$(".navigation-tab-item").removeClass("active");
