...
c.slideDown("fast",function(){f=!0}),l=p)});else{var n=a.width();0<k.length&&750<n&&$(window).scroll(function(){var p=$(window).scrollTop();400<p&&500>p||(450<=p?l>p&&m?(f=!1,h()):f&&(m=!1,g()):h(),l=p)})}})}};b.prototype.init_navigation=function(){$("#siteNav li.nav-list-item").unbind("click").bind("click",function(a){a.preventDefault();$(this).siblings().removeClass("active");$(this).addClass("active");window.scroll({top:$($(this).children("a").attr("href")).offset().top-($(".j-header").height()+
...
var d=document.querySelector("#jFloor"),e=document.querySelector("#jFloor path"),k,f;window.addEventListener("resize",a,!1);window.addEventListener("scroll",c,!1);a()};"undefined"!==typeof module&&"undefined"!==typeof module.exports?module.exports=b:window.Joe=b})();window.JoeInstance=new Joe({});
