...
var e=$("#comment-content");"canvas"===$("#commentTypeContent .canvas").attr("data-type")&&(c=$("#draw")[0].toDataURL("image/webp",.1),e.val("{!{"+c+"}!} "));if(""===e.val().trim())return $.toast({type:"warning",message:"\u8bf7\u8f93\u5165\u8bc4\u8bba\u5185\u5bb9\uff01"});if(!$(this).attr("data-disabled")){$(this).attr("data-disabled",!0);$(this).find("button[type='submit']").html("\u8bf7\u7b49\u5f85...");var k=$(".comment-btn");k.text("\u8bc4\u8bba\u4e2d..");$.ajax({url:$(this).attr("action"),type:"post",
...
$("body").css("overflow","");$(".j-header").css("box-shadow","")})};b.prototype.init_wap_sidebar=function(){$(".j-slide").unbind("click").bind("click",function(a){$(".j-search-down-xs").removeClass("active");$("body").css("overflow","");$(".j-header").css("box-shadow","");$(this).toggleClass("active");$(".j-sidebar-xs").toggleClass("active");$(this).hasClass("active")?$("body").css("overflow","hidden"):$("body").css("overflow","")});$(".j-sidebar-xs .mask").unbind("click").bind("click",function(){$(".j-slide").removeClass("active");
$(".j-sidebar-xs").removeClass("active");$("body").css("overflow","")});$(".j-sidebar-xs .item ul li a").unbind("click").bind("click",function(a){var c=$(this);c.parent().siblings(".active").toggleClass("active");if(c.next().is("ul")){if(c.parent().toggleClass("active")&&a.preventDefault())return!1}else $(".j-slide").removeClass("active"),$(".j-sidebar-xs").removeClass("active"),$("body").css("overflow","")})};b.prototype.init_wow=function(){"on"===window.JOE_CONFIG.IS_MOBILE&&"off"===window.JOE_CONFIG.DOCUMENT_WAP_ANIMATION||
