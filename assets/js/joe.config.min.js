...
(c.vod_director||"\u672a\u77e5")+"</span>\n\t\t\t\t\t\t\t</dd>\n\t\t\t\t\t\t\t<dd>\n\t\t\t\t\t\t\t\t<span>\u7b80\u4ecb\uff1a</span>\n\t\t\t\t\t\t\t\t<span>"+(c.vod_content?c.vod_content:c.vod_blurb)+"</span>\n\t\t\t\t\t\t\t</dd>\n\t\t\t\t\t\t</dl>\n\t\t\t\t\t");a.init_lazy_load();var k=c.vod_play_from.split("$$$"),f=c.vod_play_url.split("$$$"),m=new Map;k.forEach(function(q,r){m.set(q,f[r]||[])});k={};for(var g=$jscomp.makeIterator(m),h=g.next();!h.done;k={$jscomp$loop$prop$str$4:k.$jscomp$loop$prop$str$4},
h=g.next()){var l=$jscomp.makeIterator(h.value);h=l.next().value;l=l.next().value.split("#");k.$jscomp$loop$prop$str$4="";l.forEach(function(q){return function(r){q.$jscomp$loop$prop$str$4+='\n\t\t\t\t\t\t\t\t<li data-link="'+e(r).link+'">'+e(r).name+"</li>\n\t\t\t\t\t\t\t"}}(k));$("#j-video-play").append('\n\t\t\t\t\t\t\t<div class="video-list-play">\n\t\t\t\t\t\t\t\t<div class="title">\u6e90\uff1a'+h+'</div>\n\t\t\t\t\t\t\t\t<ul class="list-item">\n\t\t\t\t\t\t\t\t\t'+k.$jscomp$loop$prop$str$4+
...
400<p&&500>p||(450<=p?l>p&&m?(f=!1,g()):f&&(m=!1,h()):g(),l=p)})}})};d.prototype.init_navigation=function(){$("#siteNav li.nav-list-item").on("click",function(a){a.preventDefault();$(this).siblings().removeClass("active");$(this).addClass("active");window.scroll({top:$($(this).children("a").attr("href")).offset().top-($(".j-header").height()+20),behavior:"smooth"})})};d.prototype.init_mobinav=function(){$(".navigation-tab-item").bind("click",function(){$(".navigation-tab-item").removeClass("active");
