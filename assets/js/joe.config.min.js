...
"on"!==window.JOE_CONFIG.IS_MOBILE){var a=document.title;$(document).on("visibilitychange",function(){document.title="hidden"===document.visibilityState?window.JOE_CONFIG.DOCUMENT_TITLE:a})}};b.prototype.init_document_barrager=function(){if("off"!==window.JOE_CONFIG.DOCUMENT_BARRAGER){var a=$("#barrager");"on"===localStorage.getItem("barragerStatus")?(a.attr("checked",!0),$(".j-barrager").css({opacity:1,visibility:"visible"})):(a.attr("checked",!1),$(".j-barrager").css({opacity:0,visibility:"hidden"}));
a.on("change",function(){localStorage.setItem("barragerStatus",$(this).prop("checked")?"on":"off");a.prop("checked")?$(".j-barrager").css({opacity:1,visibility:"visible"}):$(".j-barrager").css({opacity:0,visibility:"hidden"})})}};b.prototype.init_document_progress=function(){if("off"!==window.JOE_CONFIG.DOCUMENT_PROGRESS){var a=function(){var c=$(window).scrollTop(),d=$(document).height(),e=$(window).height();c=parseInt(c/(d-e)*100);0>c&&(c=0);100<c&&(c=100);$("#progress").css("width",c+"%")};a();
$(window).on("scroll",function(){return a()})}};b.prototype.init_document_live2d=function(){"off"!==window.JOE_CONFIG.DOCUMENT_LIVE2D&&"on"!==window.JOE_CONFIG.IS_MOBILE&&L2Dwidget.init({model:{jsonPath:window.JOE_CONFIG.DOCUMENT_LIVE2D,scale:1},mobile:{show:!1},display:{position:"right",width:160,height:200,hOffset:70,vOffset:0}})};b.prototype.init_document_contextmenu=function(){if("off"!==window.JOE_CONFIG.DOCUMENT_CONTEXTMENU&&"on"!==window.JOE_CONFIG.IS_MOBILE)$(document).on("contextmenu",function(){return!1})};
b.prototype.init_document_theme=function(){if("on"===window.JOE_CONFIG.DOCUMENT_THEME_STATUS){var a=$("#colorPick");window.JOE_CONFIG.DOCUMENT_GLOBAL_THEME?$("body").css("--theme",localStorage.getItem("--theme")||window.JOE_CONFIG.DOCUMENT_GLOBAL_THEME):$("body").css("--theme",localStorage.getItem("--theme")||"#4e7cf2");var c=null;c=localStorage.getItem("--theme")?localStorage.getItem("--theme"):window.JOE_CONFIG.DOCUMENT_GLOBAL_THEME?window.JOE_CONFIG.DOCUMENT_GLOBAL_THEME:"#4e7cf2";a.colpick({flat:!0,
layout:"hex",submit:!1,color:c,colorScheme:"dark",onChange:function(d,e,k){$("body").css("--theme","#"+e);localStorage.setItem("--theme","#"+e)}});$("#openColorPick").unbind("click").bind("click",function(d){d.stopPropagation();a.toggleClass("active")});a.unbind("click").bind("click",function(d){d.stopPropagation()});$(document).bind("click",function(d){a.removeClass("active")})}else""===window.JOE_CONFIG.DOCUMENT_GLOBAL_THEME?$("body").css("--theme","#4e7cf2"):$("body").css("--theme",window.JOE_CONFIG.DOCUMENT_GLOBAL_THEME)};
b.prototype.init_hover_music=function(){if("off"!==window.JOE_CONFIG.DOCUMENT_HOVER_MUSIC&&"on"!==window.JOE_CONFIG.IS_MOBILE)$(".j-hover-music").on("mouseover",function(){$("#j-hover-music").attr("src",window.JOE_CONFIG.THEME_URL+"/assets/audio/"+(Math.floor(8*Math.random())+1)+".ogv")})};b.prototype.init_back_top=function(){if("off"!==window.JOE_CONFIG.DOCUMENT_BACK_TOP){var a=function(){500<$(window).scrollTop()?$("#backToTop").addClass("active"):$("#backToTop").removeClass("active")};a();$(window).on("scroll",
function(){return a()});$("#backToTop").unbind("click").bind("click",function(){window.scroll({top:0,behavior:"smooth"})})}};b.prototype.init_high_light=function(){"off"!==window.JOE_CONFIG.DOCUMENT_HIGHT_LIGHT&&(hljs.initHighlighting.called=!1,hljs.initHighlighting())};b.prototype.init_document_console=function(){"off"!==window.JOE_CONFIG.DOCUMENT_CONSOLE&&function(a,c){a||(!function(d){var e=e||{};e.create=function(k){function f(){window.Firebug&&window.Firebug.chrome&&window.Firebug.chrome.isInitialized?
m("on"):(l="off",console.log(n),console.clear(),m(l))}function m(r){p!==r&&(p=r,"function"==typeof g.onchange&&g.onchange(r))}"function"==typeof k&&(k={onchange:k});var h=(k=k||{}).delay||500,g={};g.onchange=k.onchange;var l,n=new Image;n.__defineGetter__("id",function(){l="on"});var p="unknown";g.getStatus=function(){return p};var q=setInterval(f,h);window.addEventListener("resize",f);var t;return g.free=function(){t||(t=!0,window.removeEventListener("resize",f),clearInterval(q))},g};"function"==
typeof define?(define.amd||define.cmd)&&define(function(){return e}):"undefined"!=typeof module&&module.exports?module.exports=e:window.jdetects=e}(),jdetects.create(function(d){var e=0;setInterval(function(){"on"===d&&setTimeout(function(){0===e&&(e=1,setTimeout(c))},200)},100)}))}(!1,function(){window.location.href=window.JOE_CONFIG.THEME_URL+"/console.html"})};b.prototype.init_document_weather=function(){if(""!==window.JOE_CONFIG.DOCUMENT_WEATHER_KEY){window.WIDGET={CONFIG:{layout:2,width:"220",
height:"270",background:"auto"===window.JOE_CONFIG.DOCUMENT_WEATHER_TYPE?1:2,dataColor:"auto"===window.JOE_CONFIG.DOCUMENT_WEATHER_TYPE?"ffffff":"303133",key:window.JOE_CONFIG.DOCUMENT_WEATHER_KEY}};var a=setTimeout(function(){$(".aside-wether .loading").addClass("active");clearTimeout(a)},1E3)}};b.prototype.init_3d_tag=function(){if("off"!==window.JOE_CONFIG.DOCUMENT_3D_TAG){var a=[];$("#cloudList li").each(function(c,d){a.push({label:$(d).attr("data-label"),url:$(d).attr("data-url"),target:"_blank"})});
$("#cloud").svg3DTagCloud({entries:a,width:220,height:230,radius:"65%",radiusMin:75,bgDraw:!0,bgColor:"#000",opacityOver:1,opacityOut:.05,opacitySpeed:6,fov:800,speed:.5,fontSize:13,fontColor:"#fff",fontWeight:"500",fontStyle:"normal",fontStretch:"normal",fontToUpperCase:!0})}};b.prototype.init_load_more=function(){if("ajax"===window.JOE_CONFIG.DOCUMENT_LOAD_MORE){var a=$(".j-loadmore a");a.attr("data-href",a.attr("href"));a.removeAttr("href");a.unbind("click").bind("click",function(){var c=this;
...
m=!0,h=function(){k.addClass("post_no");d.removeClass("post_no");e.slideDown("fast",function(){f=!0})},g=function(){k.removeClass("post_no");d.addClass("post_no");e.slideUp("normal",function(){m=!0})};$(document).ready(function(){var l=0;if(768>screen.width)$(window).scroll(function(){var p=$(window).scrollTop();395<p&&505>p||(450<=p?l>p&&m?(f=!1,c.slideDown("fast",function(){f=!0})):f&&(m=!1,c.slideUp("normal",function(){m=!0})):c.slideDown("fast",function(){f=!0}),l=p)});else{var n=a.width();0<
k.length&&750<n&&$(window).scroll(function(){var p=$(window).scrollTop();400<p&&500>p||(450<=p?l>p&&m?(f=!1,h()):f&&(m=!1,g()):h(),l=p)})}})}};b.prototype.init_navigation=function(){$("#siteNav li.nav-list-item").unbind("click").bind("click",function(a){a.preventDefault();$(this).siblings().removeClass("active");$(this).addClass("active");window.scroll({top:$($(this).children("a").attr("href")).offset().top-($(".j-header").height()+20),behavior:"smooth"})})};b.prototype.init_mobinav=function(){$(".navigation-tab-item").bind("click",
...
k,f;window.addEventListener("resize",a,!1);window.addEventListener("scroll",c,!1);a()};b.prototype.init_resource_page=function(){function a(){$.ajax({url:"/resources",method:"get",data:{category:c,tag:d,price:e,order:k},success:function(f){f=$(".row.posts-wrapper",f).html();$(".row.posts-wrapper").html(f)}})}var c,d,e,k=null;$(".filter-tag.category li a").unbind("click").bind("click",function(f){f.preventDefault();console.log("aaa");c=$(this).data("mid");$(this).hasClass("on")&&(c=null);a();$(this).toggleClass("on");
$(this).parent().siblings("li").find("a").removeClass("on")});$(".filter-tag.tag li a").unbind("click").bind("click",function(f){f.preventDefault();d=$(this).data("mid");$(this).hasClass("on")&&(d=null);a();$(this).toggleClass("on");$(this).parent().siblings("li").find("a").removeClass("on")});$(".filter-tag.price li a").unbind("click").bind("click",function(f){f.preventDefault();e=$(this).data("price");a();$(this).addClass("on");$(this).parent().siblings("li").find("a").removeClass("on")});$(".filter-tag.order li a").unbind("click").bind("click",
function(f){f.preventDefault();k=$(this).data("order");a();$(this).addClass("on");$(this).parent().siblings("li").find("a").removeClass("on")})};"undefined"!==typeof module&&"undefined"!==typeof module.exports?module.exports=b:window.Joe=b})();window.JoeInstance=new Joe({});
