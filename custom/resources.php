...
$Jcatags = $this->options->JResourceCatags; // 1||22,23 category||tsg1,tag2
$category_tags_arr = [];
if (isset($Jcatags)){
    $cts_arr = explode("\r\n",trim($Jcatags));
...
?>
<?php $this->need('common/common.header.nopjax.php'); ?>
    <section id="pjax-container">

    <section class="container j-index j-resource">
        <section class="j-adaption">
            <section class="main <?php $this->options->JListType() ?>">
                <!-- 主体 -->
                <div class="term-bar visible lazyload" data-bg="https://api.btstu.cn/sjbz/api.php" style="background-image: url(https://api.btstu.cn/sjbz/api.php);">
                        ...
                        <div class="form-box search-properties mb-0">
                            ...
                            <div class="filter-item">
                                <ul class="filter-tag category"><span><i class="icon iconfont icon-folder-open"></i> 分类</span>
                                    <li><a no-pjax href="<?php echo $this->options->index.'/resources' ?>" class="on"> 发现</a></li>
                                    <?php foreach ($showCategory as $showc):?>
                                    <li><a no-pjax href="<?php echo $showc['permalink'] ?>" data-mid="<?php echo $showc['mid'] ?>"><?php echo $showc['name'] ?></a></li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                            <!-- 相关标签 -->
                            <div class="filter-item">
                                <ul class="filter-tag tag"><span><i class="icon iconfont icon-tags"></i> 标签</span>
                                    ...
                                    <li><a no-pjax href="<?php echo genPermalink('tag',['type'=>'tag','slug'=>$showt['slug']])?>" data-mid="<?php echo $showt ['mid'] ?>"><?php _e($showt['name']);?></a></li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                            <!-- 自定义筛选 -->
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6">
                                        <ul class="filter-tag price"><span><i class="icon iconfont icon-filter"></i>价格</span>
                                            <li><a no-pjax href="/resources?price=-1" class="tab on" data-price="-1"><i></i><em>全部</em></a></li>
                                            <li><a no-pjax href="/resources?price=1" class="tab" data-price="0"><i></i><em>免费</em></a></li>
                                            <li><a no-pjax href="/resources?price=2" class="tab" data-price="3"><i></i><em>付费</em></a></li>
                                            <li><a no-pjax href="/resources?price=3" class="tab" data-price="1"><i></i><em>登录可见</em></a></li>
                                            <li><a no-pjax href="/resources?price=4" class="tab" data-price="2"><i></i><em>会员可见</em></a></li>
                                        </ul>
                                    </div>
                                    <div class="col-12 col-sm-6">
                                        <!-- 排序 -->
                                        <ul class="filter-tag order" style="width: 100%;">
                                            <div class="right">
                                                <li class="rightss"><i class="icon iconfont icon-show_more"></i><a no-pjax href="/resources?order=created" class="on" data-order="created">发布日期</a></li>
                                                <li class="rightss"><i class="icon iconfont icon-show_more"></i><a no-pjax href="/resources?order=modified" data-order="modified">修改时间</a></li>
                                                <li class="rightss"><i class="icon iconfont icon-show_more"></i><a no-pjax href="/resources?order=commentsNum" data-order="commentsNum">评论数量</a></li>
                                                <li class="rightss"><i class="icon iconfont icon-show_more"></i><a no-pjax href="/resources?order=likes" data-order="likes">点赞</a></li>
                                                <li class="rightss"><i class="icon iconfont icon-show_more"></i><a no-pjax href="/resources?order=views" data-order="views">热度</a></li>
                                            </div>
                                        </ul>
                                    </div>
                                </div>
...
<?php $this->need('common/common.footer.nopjax.php'); ?>